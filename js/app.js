...
alertBanner.innerHTML = `<div class="alert-banner"><p><strong>Alert:</strong> You have unread notifications</p>
...
// Chart Widgets
    //added with charts.js because wowza that took a lot of space!
...
send.addEventListener('click', () => {
    if (user.value === "" && message.value === "") {
        alert("Please add user and message fields before sending!");
    } else if (user.value === "") {
        alert("Please enter who you'd like to send your message to.");
...
saveButton.addEventListener('click', () => {
    ...
    if (checkboxes.checked === false && saveButton.checked === false && timezone.value === 'default') {
      return null
    } else {
      alert("Your settings will be remembered!")
    }
});
